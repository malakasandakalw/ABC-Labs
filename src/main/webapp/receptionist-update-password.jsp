...
<html>
	<head>
	   ...
	   <title>Receptionist - Update Password</title>
	      ...
	      <div class="container">
	         <div class="collapse navbar-collapse" id="navbarSupportedContent">
	            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
	               ...
	               <li class="nav-item">
	               	<a class="nav-link active" href="receptionist-update-password.jsp">Change Password</a>
	               </li>
                  <li class="nav-item">
	   ...
	   <div class="container">
		...
		<div class="col-md-5 mx-auto bg-white p-5">
			<form method="post" action="receptionists">            
              ...
              <input type="hidden" name="session_id" value="${auth_receptionist_id}"/>
